...
//        self.datePicker.countDownDuration = minuteInterval ?? default value 180
...
//    open func addTarget(){
//        self.datePicker.addTarget(self, action: Selector("datePickedValueChanged:"), for: UIControl.Event.valueChanged)
//    }
//    func datePickedValueChanged (sender: UIDatePicker) {
//        if (self.datePicker.countDownDuration > 10800) { //5400 seconds = 1h30min
